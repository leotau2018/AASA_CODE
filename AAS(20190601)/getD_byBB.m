...
% used in AASA(L-BFGS) (AASA_BB_Lbfgs_SNN_adapt1)
function [ds_e,ds_lu]=getD_byBB( S, Y, lenS, start_index, gamma, M, P, lambda,n,k_e,k_l,k_u, I_e,J_e, I_l,J_l, I_u, J_u, zc_lu, zb_l,epsilonk, z0_lu,g,cgtol,cgmaxit,type)
